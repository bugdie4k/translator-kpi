...
(deftests test-lexer ((testfiles (pathname "/home/danylo/kpi/3/translators-marchenko/translator/tests/testfiles/")))
  (correct
   ...
   '(("PROGRAM" PROGRAM 1 0) ("TEST01" USER-DEFINED-IDENTIFIER 1 8)
     ("BEGIN" BEGIN 2 0) ("LOOP" LOOP 3 2) ("FOR" FOR 4 4)
     ("I" USER-DEFINED-IDENTIFIER 4 8) (":=" ASSIGNMENT 4 10)
     ("-" MINUS-SIGN 4 13) ("1" NUMBER 4 14) ("TO" TO 4 16)
     ("12" NUMBER 4 19) ("DO" DO 4 22) ("FOR" FOR 10 8)
     ("J" USER-DEFINED-IDENTIFIER 10 12) (":=" ASSIGNMENT 10 14)
     ("2" NUMBER 10 17) ("+" PLUS-SIGN 10 18) ("3456" NUMBER 10 19)
     ("-" MINUS-SIGN 10 23) ("1" NUMBER 10 24) ("TO" TO 10 26)
     ("I" USER-DEFINED-IDENTIFIER 10 29) ("DO" DO 10 31)
     ...
     ("ENDFOR" ENDFOR 11 59) ("ENDFOR" ENDFOR 12 8)
     ("ENDFOR" ENDFOR 13 4) ("ENDLOOP" ENDLOOP 14 2))
...
")
  (error-assignment-operator
   (handler-case (lexer (merge-pathnames testfiles (pathname "./test-lexer-error-assignment-operator")))
     (wrong-character (e) (print-object e nil)))
   "Assignment operator is expected because of the colon character. Second character must be an equals sign: =.
character: 3
line: 4
column: 11
")
...
")
  (error-unexpected-eof
   (handler-case (lexer (merge-pathnames testfiles (pathname "./test-lexer-error-unexpected-eof")))
     (wrong-character (e) (print-object e nil)))
